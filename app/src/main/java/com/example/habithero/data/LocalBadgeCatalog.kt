...
object LocalBadgeCatalog {
    ...
    private val allBadges = listOf(
        ...
        Badge(
            ...
            categoryKey = "Streaks",
            sortOrder = 1,
            criteria = mapOf("currentStreak" to 1)
        ),
        Badge(
            id = "streak_3",
            name = "Streak 3 Days",
            ...
            categoryKey = "Streaks",
            sortOrder = 2,
            criteria = mapOf("currentStreak" to 3)
        ),
        Badge(
            id = "streak_7",
            name = "Streak 7 Days",
            ...
            categoryKey = "Streaks",
            sortOrder = 3,
            criteria = mapOf("currentStreak" to 7)
        ),
        Badge(
            id = "streak_14",
            name = "Streak 14 Days",
            ...
            categoryKey = "Streaks",
            sortOrder = 4,
            criteria = mapOf("currentStreak" to 14)
        ),
        Badge(
            id = "streak_30",
            name = "Streak 30 Days",
            ...
            categoryKey = "Streaks",
            sortOrder = 5,
            criteria = mapOf("currentStreak" to 30)
        ),
        Badge(
            id = "streak_100",
            ...
            categoryKey = "Streaks",
            sortOrder = 6,
            criteria = mapOf("currentStreak" to 100)
        ),
        Badge(
            id = "streak_365",
            ...
            categoryKey = "Streaks",
            sortOrder = 7,
            criteria = mapOf("currentStreak" to 365)
        ),
        ...
        Badge(
            ...
            sortOrder = 1,
            criteria = mapOf("activeHabits" to 1)
        ),
        Badge(
            id = "active_3",
            ...
            categoryKey = "Active Habits",
            sortOrder = 2,
            criteria = mapOf("activeHabits" to 3)
        ),
        Badge(
            id = "active_5",
            ...
            categoryKey = "Active Habits",
            sortOrder = 3,
            criteria = mapOf("activeHabits" to 5)
        ),
        Badge(
            id = "active_7",
            ...
            categoryKey = "Active Habits",
            sortOrder = 4,
            criteria = mapOf("activeHabits" to 7)
        ),
        Badge(
            id = "active_10",
            ...
            categoryKey = "Active Habits",
            sortOrder = 5,
            criteria = mapOf("activeHabits" to 10)
        ),
        ...
        Badge(
            ...
            sortOrder = 1,
            criteria = mapOf("totalCompleted" to 1)
        ),
        Badge(
            id = "complete_10",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 2,
            criteria = mapOf("totalCompleted" to 10)
        ),
        Badge(
            id = "complete_25",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 3,
            criteria = mapOf("totalCompleted" to 25)
        ),
        Badge(
            id = "complete_50",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 4,
            criteria = mapOf("totalCompleted" to 50)
        ),
        Badge(
            id = "complete_100",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 5,
            criteria = mapOf("totalCompleted" to 100)
        ),
        Badge(
            id = "complete_500",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 6,
            criteria = mapOf("totalCompleted" to 500)
        ),
        Badge(
            id = "complete_1000",
            ...
            categoryKey = "Completed Habits",
            sortOrder = 7,
            criteria = mapOf("totalCompleted" to 1000)
        )
    )
