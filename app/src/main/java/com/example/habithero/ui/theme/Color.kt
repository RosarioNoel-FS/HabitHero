...
val CardDarkBlue = Color(0xFF1F2937)
val HeroGold = Color(0xFFFF9C07)
val HeroGoldDark = Color(0xFFC97209) // Darker Gold for gradient
val TextGray = Color(0xFFA0AEC0)
val White = Color(0xFFFFFFFF)
val GoldTransparent = Color(0x33FFC107) // 20% alpha gold
...
val HeroGoldLight = Color(0xFFFA8202)

// Completed Green Colors
val CompletedGreen = Color(0xFF76FF03)
val CompletedGreenDark = Color(0xFF64DD17)
